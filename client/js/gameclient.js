            ...
            if(dispatcherMode) {
                this.connection.onmessage = function(e) {
                    ...
                    if(reply.status === 'OK') {
                        ...
                        alert("TalonQuest is currently at maximum player population. Please retry later.");
                    } else {
                        alert("Unknown error while connecting to TalonQuest.");
                    }
                };
            } else {
                ...
                this.connection.onclose = function() {
                    ...
                    if(self.disconnected_callback) {
                        if(self.isTimeout) {
                            ...
                            self.disconnected_callback("The connection to TalonQuest has been lost");
                        }
                    }
                };
            }
