...
function(InfoManager, BubbleManager, Renderer, Map, Animation, Sprite, AnimatedTile,
    ...
    var Game = Class.extend({
        ...
        connect: function(started_callback) {
            ...
            this.client.onWelcome(function(id, name, x, y, hp) {
                ...
                if(!self.storage.hasAlreadyPlayed()) {
                    ...
                    self.showNotification("Welcome to TalonQuest!");
                } else {
                    self.showNotification("Welcome back to TalonQuest!");
                ...
                self.player.onStep(function() {
                    ...
                    // Keep the Wild banner in sync with player position. The
    	    ...
    	    && !this.hoveringPlateauTile) {
        	    ...
        	    if(entity instanceof Mob) {
        	        ...
        	        if(inWild(me.gridX, me.gridY) && inWild(entity.gridX, entity.gridY)) {
        	            ...
        	            this.showNotification("You can only attack other players in The Wild.");
        	        }
        	    }
        ...
        // Toggle the persistent "The Wild" warning banner at the top of the viewport.
        setWildBanner: function(on) {
            var banner = document.getElementById('wild-banner');
            if(!banner) { return; }
            if(on) { banner.classList.add('visible'); }
            else   { banner.classList.remove('visible'); }
        },

        // Sent when the player presses F or types /fish. Sends a chat command
